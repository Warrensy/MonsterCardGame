...
namespace MonsterCardGame
{
    class CardDB
    {
        ...
        MonsterCard newCard1 = new MonsterCard(7, "Fire Dragon", Card.MonsterType.Dragon, Card.ElementType.Fire, 1, Card.MonsterType.FireElves);
        MonsterCard newCard2 = new MonsterCard(2, "Shining Knight", Card.MonsterType.Knight, Card.ElementType.Normal, 2, Card.MonsterType.Water);
        MonsterCard newCard3 = new MonsterCard(4, "Goblin", Card.MonsterType.Goblin, Card.ElementType.Normal, 3, Card.MonsterType.Dragon);
        MonsterCard newCard4 = new MonsterCard(7, "Kraken", Card.MonsterType.Kraken, Card.ElementType.Water, 4, Card.MonsterType.None);
        MonsterCard newCard5 = new MonsterCard(4, "Fire Elves", Card.MonsterType.FireElves, Card.ElementType.Fire, 5, Card.MonsterType.None);
        MonsterCard newCard6 = new MonsterCard(4, "Ork", Card.MonsterType.Ork, Card.ElementType.Normal, 6, Card.MonsterType.Wizzard);
        MonsterCard newCard7 = new MonsterCard(8, "Water Spell", Card.MonsterType.Spell, Card.ElementType.Water, 7, Card.MonsterType.Kraken);
        MonsterCard newCard8 = new MonsterCard(3, "Fire Spell", Card.MonsterType.Spell, Card.ElementType.Fire, 8, Card.MonsterType.Kraken);
        MonsterCard newCard9 = new MonsterCard(3, "Normal Spell", Card.MonsterType.Spell, Card.ElementType.Normal, 9, Card.MonsterType.Kraken);
        MonsterCard newCard10 = new MonsterCard(7, "Fire Wizzard", Card.MonsterType.Wizzard, Card.ElementType.Fire, 10, Card.MonsterType.None);
    }
}
